<template>
  <div style="height:100%; width:100%;">
    <div id="float-dropdown-menu">
      <el-dropdown split-button type="primary" @command="loadSpots" style="background-color: #1d7155;border-color: #1d7155;color:#ffffff;">
        行政级别
        <el-dropdown-menu slot="dropdown" style="background-color: #1d7155;border-color: #1d7155;color:#ffffff;">
