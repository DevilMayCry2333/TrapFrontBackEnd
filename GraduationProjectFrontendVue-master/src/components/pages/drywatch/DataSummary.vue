<template>
  <div>
    ...
    <el-tabs id="statistics-tabs" v-model="tabPage" type="card">
            ...
            <el-card :header="'各' + contentLabelDict[contentLabelIndex] + '注干剂情况表'" style="padding:5px" v-if="this.$store.state.user.role < 4">
            ...
            <el-card header="各工人注干剂情况表" style="padding:5px" v-if="this.$store.state.user.role >3">
            ...
            <el-card header="各项目工程注干剂情况表" style="padding:5px" v-if="this.$store.state.user.role ==3">
